  ...
  const footerSections = [
    {
      title: 'Platform',
      links: [
        { name: 'Agent Gallery', href: '/agents' },
    ...
    },
    {
      ...
      links: [
        ...
        { name: 'Docker Images', href: '/docker' },
      ...
      <div className="container mx-auto px-6 py-16">
        <div className="grid md:grid-cols-2 lg:grid-cols-6 gap-8">
          ...
          <div className="lg:col-span-2">
            <div className="flex items-center mb-4">
              ...
              <h3 className="text-xl font-bold">Ask My Copilot</h3>
            </div>
            <p className="text-gray-400 mb-6 leading-relaxed">
              The ultimate platform for building, deploying, and managing AI agents. 
              Automate your workflow with intelligent agents that learn and adapt.
            </p>
          ...
          <div className="grid md:grid-cols-2 gap-8 items-center">
            <div>
              ...
              <p className="text-gray-400">
                Get the latest AI agent updates, tutorials, and exclusive workshop invites.
              </p>
            </div>
        ...
        <div className="border-t border-gray-800 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center">
          <div className="text-gray-400 text-sm mb-4 md:mb-0">
            © {currentYear} Ask My Copilot. All rights reserved.
          </div>
